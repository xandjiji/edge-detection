function renderTabela(){
    ...
    for(let i = 0; i < 5; i++) { // i = linha
        table += "<tr>";

        table += "<th>" + whichFilter(i+10) + "</th>";

        for(let j = 0; j < 5; j++) { // j = coluna
            if(i <= j) {
...
function whichFilter(i) {
    ...
    switch (i) {
        ...
        case 10: return 'Sobel';
        case 11: return 'Prewitt';
        case 12: return 'Roberts';
        case 13: return 'Laplacian';
        case 14: return 'Canny';
        default: return console.log("oopsie");
    }
}
